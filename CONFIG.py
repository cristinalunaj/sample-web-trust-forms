...
DATABASE_URL = "dbname=suppliers user=cris" #os.environ['DATABASE_URL']  # "dbname=suppliers user=cris"  # os.environ['DATABASE_URL']    ### local: "dbname=suppliers user=cris" ## heroku: os.environ['DATABASE_URL']
